...
- Realty Art (Nome do plugin)
- realty-art (nome dos arquivos, nome do text domain e slug da url do repositório)
- RA_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- ra_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Realty Art, através do próprio sistema de atualizações do WordPress
